...
if (screen.width > 1024) {
    ...
    $(document).ready(function() { //when the document is ready...
        ...
        var $BG11c = $('#waiting').find('.frame'); //frame
        ...
        */
        ...
        function Move() {
            ...
            if ($BG3a.hasClass("inview")) { // Intro Her - Chris Neal
                $BG3a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 3), .6, 0)
                }); // city
                $BG3b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 3), .4, 0),
                    'height': panelHeight
                }); // stars
                $BG3c.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 3), .2, 0),
                    'height': panelHeight
                }); // moon
                $BG3d.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 3), -.4, 0),
            ...
            if ($BG5a.hasClass("inview")) { // Intro Him - Frank Stockton
                $BG5a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 5), .3, 0)
                }); // lights
                $BG5b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 5), .45, 0),
                    'height': panelHeight
                }); // russ
                $BG5c.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 5), .6, 0),
                    'height': panelHeight
                }); // microphone
                $BG5d.css({
                    'height': panelHeight
            ...
            if ($BG7a.hasClass("inview")) { // Discovery - Nick Felton
                $BG7a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 7), .2, 0)
                });
                $BG7b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 7), -.2, 0),
                    'height': panelHeight
            ...
            if ($BG9a.hasClass("inview")) { // Star Crossed - Sam Weber 
                $BG9a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 9), .6, 0)
                }); //jessica
                $BG9b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 9), -2, 0),
                    'height': panelHeight
                });
                $BG9c.css({
                    'height': panelHeight
            ...
            if ($BG13a.hasClass("inview")) { // Closed - Gilbert Ford
                ...
                $BG13b.css({
                    'backgroundPosition': CalculateShift('bottom', 'static', pos, (panelHeight * 13), .1, 0),
                    'height': panelHeight
                }); //snow1
                $BG13c.css({
                    'backgroundPosition': CalculateShift('bottom', 'static', pos, (panelHeight * 13), -.2, 0),
                    'height': panelHeight
                }); //snow2
                $BG13d.css({
                    'height': panelHeight
            ...
            if ($BG15a.hasClass("inview")) { // Falling in Love - Jason Kernevich
                $BG15a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 15), .6, 0)
                });
                $BG15b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 15), -.3, 0),
                    'height': panelHeight
                });
                $BG15c.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 15), 1.2, 0),
                    'height': panelHeight
                });
                $BG15d.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 15), .6, 0),
            ...
            if ($BG17a.hasClass("inview")) { // High Seas - Chris Buzelli
                $BG17a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 17), .6, 0),
                    'height': panelHeight
                });
                $BG17b.css({
                    'height': panelHeight
            ...
            if ($BG19a.hasClass("inview")) { // New Lives - Grady McFerrin
                ...
                if (pos <= cuePos) {
                    $BG19a.css({
                        'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 19), -1, 0)
                    }); // radio
                    $BG19b.css({
                        'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 19), 0, 0),
                        'height': panelHeight
                    }); // heads
                    $BG19c.css({
                        'backgroundPosition': CalculateShift('bottom', 'static', pos, (panelHeight * 19), 1.4, 0),
                        'height': panelHeight
                    }); // letters
                } else {
                    $BG19a.css({
                    ...
                    $BG19c.css({
                        'backgroundPosition': CalculateShift('bottom', 'static', pos, (panelHeight * 19), 1, 0),
                        'height': panelHeight
                    }); // letters
                }
            ...
            if ($BG21a.hasClass("inview")) { // The Big Move - Alex Eben Meyer
                $BG21a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 21), .6, 0)
                }); // background
                $BG21b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 21), .8, 0),
                    'height': panelHeight
                }); // moon
                $BG21c.css({
                    'backgroundPosition': CalculateShift('middle', 'center', pos, (panelHeight * 21), .6, -.1),
                    'height': panelHeight
                }); // city
                $BG21d.css({
                    'backgroundPosition': CalculateShift('middle', 'center', pos, (panelHeight * 21), .6, .7),
                    'height': panelHeight
                }); // taxi
                $BG21e.css({
                    'backgroundPosition': CalculateShift('middle', 'center', pos, (panelHeight * 21), .6, .4),
                    'height': panelHeight
                }); // j + r
                $BG21f.css({
                    'backgroundPosition': CalculateShift('middle', 'center', pos, (panelHeight * 21), .6, -.5),
                    'height': panelHeight
                }); // building
                $BG21g.css({
                    'height': panelHeight
            ...
            if ($BG23a.hasClass("inview")) { // Jessica! - Neil Swaab
                $BG23a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 23), .6, 0)
                }); // office
                $BG23b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 23), -.2, 0),
                    'height': panelHeight
                }); // bubble 1
                $BG23c.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 23), .1, 0),
                    'height': panelHeight
                }); // bubble 2
                $BG23d.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 23), .6, 0),
            ...
            if ($BG25a.hasClass("inview")) { // Broke - Jennifer Daniel
                ...
                if (pos >= vertPos) {
                    $BG25a.css({
                        'backgroundPosition': CalculateShift('middle', 'center', pos, (panelHeight * 25), 2.2, -.6)
                    });
                    $BG25b.css({
                        'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 25), 0, 0),
                        'height': panelHeight
                    });
                    $BG25c.css({
                        'backgroundPosition': CalculateShift('middle', 'center', pos, (panelHeight * 25), 2.2, -.6),
                    ...
                    $BG25a.css({
                        'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 25), -.2, 0)
                    });
                    $BG25b.css({
                        'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 25), -.2, 0),
                        'height': panelHeight
            ...
            if ($BG29a.hasClass("inview")) { // Park - Gina + Matt
                $BG29a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 29), .1, 0)
                });
                $BG29b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 29), .3, 0),
                    'height': panelHeight
                });
                $BG29c.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 29), -1.1, 0),
                    'height': panelHeight
                });
                $BG29d.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 29), .3, 0),
            ...
            if ($BG31a.hasClass("inview")) { // Restaurant - James Gulliver Hancock
                $BG31a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 31), .8, 0)
                });
                $BG31b.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 31), .6, 0),
                    'height': panelHeight
                });
                $BG31c.css({
                    'height': panelHeight
            ...
            if ($BG33a.hasClass("inview")) { // Friends - Jillian Tamaki
                $BG33a.css({
                    'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 33), .6, 0)
                });
            ...
            if ($BG34a.hasClass("inview")) { // Invite
                ...
                $BG34d.css({
                    'height': frontHeight,
                    'top': panelHeight - frontHeight + 1
                });

                if (pos >= cuePos) {
                    $BG34c.css({
                        'margin-top': panelHeight - 592
                    }); // envelope back
                } else {
                    $BG34c.css({
                        'margin-top': panelHeight - 252
                    }); // envelope back
                }
